...
router.route('/').get(authentication_1.authentication, (0, authentication_1.restrictFunctionalityTo)('admin'), user_1.getAllUsers);
...
router.route('/deleteAccount').delete(authentication_1.authentication, (0, authentication_1.restrictFunctionalityTo)('user'), user_1.deleteAccount);
